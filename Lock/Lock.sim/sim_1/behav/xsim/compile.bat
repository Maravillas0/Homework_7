...
REM
REM Generated by Vivado on Mon Sep 14 11:27:36 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj lock_controller_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lock_controller_tb_vlog.prj -log xvlog.log
