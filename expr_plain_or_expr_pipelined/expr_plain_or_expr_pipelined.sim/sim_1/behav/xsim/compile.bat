...
REM
REM Generated by Vivado on Mon Sep 14 15:16:24 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj expr_pipelined_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj expr_pipelined_tb_vlog.prj -log xvlog.log
