...
HD_PWD='D:/Homework_7/expr_plain_or_expr_pipelined/expr_plain_or_expr_pipelined.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log expr_pipelined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source expr_pipelined.tcl -notrace
