...
HD_PWD='D:/Homework_7/expr_plain_or_expr_pipelined/expr_plain_or_expr_pipelined.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log expr_pipelined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source expr_pipelined.tcl
